...
When using LLVM you'll also need an LLVM install of LLVMv17 and an appropriate `LLVM_SYS_221_PREFIX` environment variable.
```bash
export LLVM_SYS_221_PREFIX="$LLVM_PATH"
```
