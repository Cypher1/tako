...
DefinitionCore<Checks> check(std::vector<Symbol> def_path,
...
ValueCore<Checks> check(std::vector<Symbol> path, const ValueCore<Empty> &val,
                        CheckerContext &ctx) {
...
ModuleCore<Checks> check(std::vector<Symbol> path,
                         const ModuleCore<Empty> &module, CheckerContext &ctx) {
