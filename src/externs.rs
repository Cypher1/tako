...
pub fn prim_add(l: &Val, r: &Val, _info: &Info) -> Res {
    ...
    match (l, r) {
        ...
        (PrimVal(Str(l)), PrimVal(Str(r))) => Ok(PrimVal(Str(l.to_string() + r))),
